...
document.addEventListener("DOMContentLoaded", function () {
    if(!localStorage.getItem("clear_session456")){
        localStorage.clear();
        localStorage.setItem("clear_session456", "true")
    }
    let storeId = $("#whatsappStoreId").val();
...
function prepareAndSendWpMessage(order, paymentId) {
    ...
    order.products.forEach((product, index) => {
        ...
        if (storeId != 345 && storeId != 1249 && storeId != 1488 && storeId != 1778 && storeId != 1628 && storeId != 1904) {
...
function directWhatsappShare(){
    ...
    products = Object.values(storeCart)
        ...
        if (product.selectAttribute) {
            ...
            if(storeId != 1778 && storeId != 1628 && storeId != 1904){
                message += 'Product URL' + ` : ${productUrl}\n`;
            }
...
function prepareAndSendWpMessageForPhonepe(order, paymentId,storeInfo) {
    ...
    order.products.forEach((product, index) => {
        ...
        if (storeId != 345 && storeId != 1249 && storeId != 1778 && storeId != 1628 && storeId != 1904) {
            message += 'Product URL' + ` : ${productUrl}\n`;
        }
