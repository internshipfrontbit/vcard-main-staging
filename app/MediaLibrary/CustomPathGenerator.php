...
class CustomPathGenerator implements PathGenerator
{
    public function getPath(Media $media): string
    {
        ...
        switch ($media->collection_name) {
            ...
            case WhatsappStore::COVER_VIDEO:
                return str_replace('{PARENT_DIR}', WhatsappStore::COVER_VIDEO, $path);                
            ...
            case WhatsappStore::EXTRA_COVER_IMAGES:
                return str_replace('{PARENT_DIR}', WhatsappStore::EXTRA_COVER_IMAGES, $path);                 
