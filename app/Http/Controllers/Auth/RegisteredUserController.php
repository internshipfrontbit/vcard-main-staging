...
class RegisteredUserController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $referral_code = request()->query('referral-code');
        if ($referral_code) {
            $response = new \Illuminate\Http\Response(view('auth.register', ['registerImage' => $registerImage]));
            $response->withCookie(cookie('referrel_code', $referral_code, 45000));
            return $response;
        }
