...
Route::get('/whatsapp-store/get-data/{alias}', [WhatsappStoreController::class, 'apiShow']);
Route::get('whatsapp-store/get-product-data/{alias}/{categoryId?}', [WhatsappStoreController::class, 'apiShowProducts']);
Route::get('whatsapp-store/get-product-details/{alias}/{id}', [WhatsappStoreController::class, 'apiProductDetails']);
Route::post('whatsapp-store/add-order/product-buy', [WhatsappStoreProductController::class, 'apiProductBuy']);
Route::post('whatsapp-store/add-order/product-buy-online', [WhatsappStoreProductController::class, 'createOnlinePaymentIntent']);
...
Route::get('whatsapp-store/get-product-details/{alias}/{id}', [WhatsappStoreController::class, 'apiProductDetails'])->middleware('language');
Route::post('whatsapp-store/add-order/product-buy', [WhatsappStoreProductController::class, 'apiProductBuy'])->middleware('language');
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('whatsapp-store/new-store/update', [WhatsappStoreController::class, 'updateAPI']);
    ...
    Route::get('whatsapp-store/new-store/current-subscription-plan', [SubscriptionController::class, 'getCurrentPlanAPI']);
    Route::get('whatsapp-store/new-store/subscription-requestes', [SubscriptionController::class, 'getPlanRequestsAPI']);
    Route::post('whatsapp-store/new-store/subscription-requestes/accept-reject', [SubscriptionController::class, 'PlanRequestsAcceptAPI']);
    ...
    Route::get('whatsapp-store/product/{alias}/products', [WhatsappStoreProductController::class, 'getStoreProducts']);
    Route::get('whatsapp-store/product/{alias}/categories-currencies', [WhatsappStoreProductController::class, 'getCategoriesAndCurrencies']);
    Route::post('whatsapp-store/product/{storeAlias}/{productId}/update', [WhatsappStoreProductController::class, 'updateProduct']);
    Route::post('whatsapp-store/product/{storeAlias}/bulk-update', [WhatsappStoreProductController::class, 'updateBulkProduct']);
    Route::delete('whatsapp-store/product/{storeAlias}/destroy/{productId}', [WhatsappStoreProductController::class, 'destroyProduct']);

    Route::middleware(['api'])->group(function () {
        Route::get('whatsapp-stores/{wpOrder}/order', [WhatsappStoreProductController::class, 'showOrder']);
        Route::post('whatsapp-stores/{wpOrder}/order', [WhatsappStoreProductController::class, 'updateOrderStatusApi'])->name('wp.stores.update.order.status');
        Route::post('whatsapp-stores/{wpOrder}/payment-status', [WhatsappStoreProductController::class, 'updateOrderPaymentStatusApi'])->name('wp.stores.update.order.paymentstatus');
    });
    
    Route::get('whatsapp-store/{storeAlias}/categories', [ProductCategoryController::class, 'listByAlias']);
    Route::get('whatsapp-store/{storeAlias}/categories/{categoryId}', [ProductCategoryController::class, 'showByAlias']);
    Route::post('whatsapp-store/{storeAlias}/categories', [ProductCategoryController::class, 'storeByAlias']);
    Route::post('whatsapp-store/{storeAlias}/categories/{categoryId}', [ProductCategoryController::class, 'updateByAlias']);
    Route::delete('whatsapp-store/{storeAlias}/categories/{categoryId}', [ProductCategoryController::class, 'destroyByAlias']);
