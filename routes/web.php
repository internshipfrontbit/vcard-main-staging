...
Route::middleware(['freshInstall'])->group(function () {
        ...
        Route::prefix('admin')->middleware('role:admin')->group(function () {
            ...
            Route::middleware('multi_tenant')->group(function () {
                ...
                Route::middleware('subscription')->group(function () {
                    ...
                    Route::post('whatsapp-stores/{whatsappStore}/update-social-links', [WhatsappStoreController::class, 'updateSocialLinks'])->name('whatsapp.stores.update.sociallink');
                    Route::post('/whatsapp/stores/{whatsappStore}/update-youtube-embeded', [WhatsappStoreController::class, 'updateYoutubeEmbeded'])->name('whatsapp.stores.update.youtubeEmbeded');      
                    Route::post('/whatsapp/stores/{whatsappStore}/update-offer-text', [WhatsappStoreController::class, 'updateOfferText'])->name('whatsapp.stores.update.offerText');      
                    Route::post('/whatsapp/stores/{whatsappStore}/update-customized-theme', [WhatsappStoreController::class, 'updateCustmizeTheme'])->name('whatsapp.stores.update.customized-theme');   
                    Route::post('/whatsapp/stores/{whatsappStore}/update-pages', [WhatsappStoreController::class, 'updateWPPages'])->name('whatsapp.stores.update.pages');
                    Route::post('/whatsapp/stores/{whatsappStore}/update-payment-config', [WhatsappStoreController::class, 'updatePaymentConfig'])->name('whatsapp.stores.update.paymentConfig');                      
                                       
                    Route::post('wp-template/{whatsappStore}/update', [WhatsappStoreController::class, 'wpTemplateUpate'])->name('wp.template.update');

                    Route::post('/whatsapp/stores/{id}/dropdown-update', [WhatsappStoreController::class, 'updateDropdownOptions'])
                        ->name('admin.store.dropdown.update');                    
                    Route::get('/whatsapp/stores/{id}/dropdown-delete', [WhatsappStoreController::class, 'deleteDropdownOption'])
                        ->name('admin.store.dropdown.delete');     
                        
                    Route::post('/whatsapp/stores/{id}/theme-update', [WhatsappStoreController::class, 'updateThemeSettings'])
                        ->name('admin.store.theme.update');   


                    // WP SEo
                    Route::post('wp-template/{whatsappStore}/update-seo', [WhatsappStoreController::class, 'wpTemplateSEOUpdate'])->name('wp.template.seo.update');
                    ...
                    Route::post('/whatsapp/stores/{wpOrder}/update-shipping', [DeliveryController::class, 'pushOrderToDelcaper'])->name('whatsapp.stores.update.shipping');   
                    Route::get('/whatsapp/stores/track-shipping/{id}', [DeliveryController::class, 'trackOrder'])->name('whatsapp.stores.track.shipping');   
                    ...
                    Route::post('whatsapp-stores/{wpOrder}/payment-status', [WhatsappStoreProductController::class, 'updateOrderPaymentStatus'])->name('wp.stores.update.order.paymentstatus');
                    Route::get('whatsapp-stores/{wpOrder}/order/invoice', [WhatsappStoreProductController::class, 'downloadInvoice'])->name('whatsapp.orders.invoice.download');
                    Route::get('whatsapp-stores/{wpOrder}/order/shipping-label', [WhatsappStoreProductController::class, 'generateShippingInvoice'])->name('whatsapp.orders.shipping.label');
                    Route::post('whatsapp-stores/{wpOrder}/order/invoice/update', [WhatsappStoreProductController::class, 'updateInvoiceDetails'])->name('whatsapp.orders.invoice.update');
                    
                    Route::prefix('api-orders')->group(function () {
                        Route::get('/', [WhatsappStoreProductController::class, 'wp_api_index']);
                        Route::get('/{id}', [WhatsappStoreProductController::class, 'wp_api_show']);
                        Route::post('/', [WhatsappStoreProductController::class, 'wp_api_store']);
                        Route::put('/{id}', [WhatsappStoreProductController::class, 'wp_api_update']);
                        Route::delete('/{id}', [WhatsappStoreProductController::class, 'wp_api_destroy']);
                        Route::post('/bulk-update-status', [WhatsappStoreProductController::class, 'wp_api_bulkUpdateStatus']);
                    });

                    Route::delete('/whatsapp/stores/media/{id}', [WhatsappStoreController::class, 'deleteExtraCoverImage'])->name('whatsapp.stores.media.delete');
    ...
    Route::get('info', [WhatsappStoreController::class, 'infoPage'])->name('whatsapp.store.info')->middleware('language');
    Route::get('generate-qr-code', [WhatsappStoreController::class, 'qrcodePage'])->name('whatsapp.store.qrpage')->middleware('language');
    Route::get('partner', [WhatsappStoreController::class, 'partnerPage'])->name('whatsapp.store.partnerpage')->middleware('language');
...
//  rezorpay
    ...
    Route::get('whatsapp-store/{alias}/about-us', [WhatsappStoreController::class, 'about'])->name('whatsapp.store.about')->middleware('language');
    Route::get('whatsapp-store/{alias}/privacy-policy', [WhatsappStoreController::class, 'privacyPolicy'])->name('whatsapp.store.privacy')->middleware('language');
    Route::get('whatsapp-store/{alias}/terms-conditions', [WhatsappStoreController::class, 'termsConditions'])->name('whatsapp.store.terms')->middleware('language');
    Route::get('whatsapp-store/{alias}/shipping-payment-policy', [WhatsappStoreController::class, 'shippingPaymentPolicy'])->name('whatsapp.store.shipping')->middleware('language');
    Route::get('whatsapp-store/{alias}/refunds-cancellation', [WhatsappStoreController::class, 'refundsCancellation'])->name('whatsapp.store.refunds')->middleware('language');    
    Route::get('whatsapp-store/{alias}/contact-us', [WhatsappStoreController::class, 'contactUs'])->name('whatsapp.store.contactUs')->middleware('language'); 
    
    Route::get('store/{alias}', [WhatsappStoreController::class, 'show'])->name('whatsapp.store.show')->middleware('language');
    Route::get('store/{alias}/products/{categoryId?}', [WhatsappStoreController::class, 'showProducts'])->name('whatsapp.store.products')->middleware('language');
    Route::get('store/{alias}/{id}/product-details', [WhatsappStoreController::class, 'productDetails'])->name('whatsapp.store.product.details')->middleware('language');
    Route::post('store/product-buy', [WhatsappStoreProductController::class, 'productBuy'])->name('whatsapp.store.product.buy');

    Route::get('common-store/auth-login', [WhatsappStoreController::class, 'showLogin'])->name('whatsappstore.auth.login');
    Route::post('common-store/auth-login', [WhatsappStoreController::class, 'login'])->name('whatsappstore.login.submit');
    Route::get('common-store/page-logout', [WhatsappStoreController::class, 'logout'])->name('whatsappstore.page.logout');
  ...
  // store rezorpay
    Route::post('store/finalize-order', [WhatsappStoreProductController::class, 'finalizeOrder'])->name('whatsapp.store.finalize.order');  
    ...
    Route::get('store/{alias}/terms-conditions', [WhatsappStoreController::class, 'termsConditions'])->name('whatsapp.store.terms')->middleware('language');
    Route::get('store/{alias}/shipping-payment-policy', [WhatsappStoreController::class, 'shippingPaymentPolicy'])->name('whatsapp.store.shipping')->middleware('language');
    Route::get('store/{alias}/refunds-cancellation', [WhatsappStoreController::class, 'refundsCancellation'])->name('whatsapp.store.refunds')->middleware('language');    
    Route::get('store/{alias}/contact-us', [WhatsappStoreController::class, 'contactUs'])->name('whatsapp.store.contactUs')->middleware('language');
