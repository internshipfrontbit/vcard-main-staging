  ...
  gtag('config', 'G-09N4LSDC8Z');
					...
					<body>
						<a href="https://staging.vcardking.com/whatsapp-store/jewellery-shop" target="_blenk" class="floating-cta">📲 
							<span data-key="order">ડેમો જુઓ</span>
						</a>
						...
						<header>
							...
							<br>
								<h1 data-key="headline" style="font-size:25px">🚀 દોઢ રૂપિયામાં તમારી વેબસાઈટ!</h1>
								<p data-key="subhead"  style="font-size:16px">📣 શું તમારે વોટ્સએપ પર સીધા ઓર્ડર જોઈએ છે?</p>
							</header>
							<div class="container">
								<div class="card" data-aos="fade-up">
									<h2 data-key="title1"  style="font-size:20px">નમસ્તે 🙏</h2>
									<p data-key="desc1">📱 વોટ્સએપ સ્ટોર એ તમારી પોતાની પ્રોફેશનલ શોપિંગ વેબસાઈટ છે – જ્યાં તમે તમારી બધી પ્રોડક્ટ્સ બતાવી શકો છો અને ગ્રાહકો માત્ર 1 ક્લિકમાં વોટ્સએપ પર ઓર્ડર આપી શકે છે.</p>
									<br>
										<p data-key="desc2">🛠 એડમિન પેનલ સાથે પૂરું કંટ્રોલ</p>
										<br>
											<p data-key="desc3">💰 વર્ષના માત્ર ₹500 (₹1.5/દિવસ)</p>
											<br>
												<a href="http://wa.me/917984847580?text=I want free demo." target="_blenk" class="btn" data-key="btn3">🎁 ફ્રી ડેમો બુક કરો</a>
												<a href="https://staging.vcardking.com/register" target="_blenk" class="btn" data-key="btn1">💼 વોટ્સએપ સ્ટોર બનાવો</a>
												<a href="tel:+917984847580" target="_blenk" class="btn" data-key="btn2">📞 +91-79848-47580</a>
											</div>
											<div class="card" data-aos="fade-up">
												<h2 data-key="title2" style="font-size:20px">✨ દરેક પ્રકારના બિઝનેસ માટે પરફેક્ટ છે.</h2>
												<div class="demo-button-grid">
													...
													<button onclick="window.open('https://staging.vcardking.com/whatsapp-store/grocery-shop')"  target="_blenk" class="demo-btn grocery">🛍️ 
														<span data-key="grocery">ગ્રોસરી</span>
													</button>
												</div>
											</div>
											<div class="card" data-aos="fade-up">
												<h2 data-key="video2" style="font-size:20px">🤔 વોટ્સએપ સ્ટોર શું છે?</h2>
												<iframe 
  width="100%" 
  height="320" 
  src="https://www.youtube.com/embed/VycRDuoPk_s?rel=0&enablejsapi=1&modestbranding=1&showinfo=0&controls=1" 
  title="What is WhatsApp Store?" 
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
  allowfullscreen></iframe>
											</div>
											<div class="card" data-aos="fade-up">
												<h2 data-key="video1" style="font-size:20px">🔍 વોટ્સએપ સ્ટોર કેવી રીતે સેટઅપ કરવું?</h2>
												<iframe
    width="100%"
    height="320"
    ...
    allowfullscreen></iframe>
											...
											<div class="card" data-aos="fade-up">
												...
												<p>
													...
													<br>
														<p>
															<a href="https://maps.app.goo.gl/uGiQHLvZpyqD4jD68" target="_blenk" style="color:#fff;text-decoration:none !important">📍 G-44/45, પ્લેટિનમ પોઈન્ટ, સામે. CNG પંપ, મોટા વરાછા, સુરત, ગુજરાત 394101
																<a/>
															</p>
															<br>
																<p>🇮🇳 Made in India</p>
    ...
    const translations = {
      gu: {
        ...
        title1: "નમસ્તે 🙏",
        desc1: "📱 તમારી પોતાની પ્રોફેશનલ શોપિંગ વેબસાઈટ, જ્યાં ગ્રાહકો માત્ર 1 ક્લિકમાં વોટ્સએપ પર ઓર્ડર આપી શકે છે.",
      ...
      hi: {
        headline: "🚀 डेढ़ रुपए में आपकी वेबसाइट!",
        subhead: "📣 क्या आप सीधे व्हाट्सएप पर ऑर्डर करना चाहते हैं?",
        title1: "नमस्ते 🙏",
        desc1: "📱 आपकी खुद की प्रोफेशनल शॉपिंग वेबसाइट जहाँ ग्राहक सिर्फ 1 क्लिक में WhatsApp पर ऑर्डर कर सकते हैं।",
      ...
      en: {
        ...
        title1: "Hello 🙏",
        desc1: "📱 Your own professional shopping website where customers can order in just 1 click on WhatsApp.",
    ...
    langSelector.addEventListener('change', function() {
      ...
      const data = translations[lang] || translations['gu'];
