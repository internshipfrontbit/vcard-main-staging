...
<body class="bg-primary-100">
    <div>
        ...
        <div
            ...
            {{-- profile --}}
            <div class="profile-section pb-3 px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                <div class="position-absolute vector-bg-1 vector-bg">
                    <img src="{{ asset('assets/img/vcard12/vector-gym-1.png') }}" alt="images" />
                </div>
                <div class="position-absolute vector-bg-2 vector-bg text-end">
                    <img src="{{ asset('assets/img/vcard12/vector-gym-2.png') }}" alt="images" />
                </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section position-relative px-30 ">
                    ...
                    <div class="chest-expander-img" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <img src="{{ asset('assets/img/vcard12/chest-expander.png') }}" alt="chest-expander" />
                    </div>
                    <div class="dumbbell-img" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box">
                                        <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard12/bod-icon.png') }}" />
                                            </div>
                                            <div class="contact-desc text-center">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard12/location-icon.png') }}" />
                                            </div>
                                            <div class="contact-desc text-center">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pb-40 px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="section-heading text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">
                            ...
                            <div class="row justify-content-center">
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-12 col-sm-9 mx-auto">
                                        <div class="mb-10 p-1 d-flex align-items-center justify-content-between business-card overflow-hidden">
                                            <div class="fs-14 p-2 w-50 text-center">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}</div>
                                            <div class="fs-14 p-2 w-50 text-center text-white">{!! $dayTime ?? '<span class="text-primary">' . __('messages.common.closed') . '</span>' !!}</div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="appointment-section pt-3 pb-4 mt-3 mb-5 px-30">
                        ...
                        <div class="appointment mt-3 pt-3">
                            <div class="row">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary w-53 appointmentAdd rounded-2 d-none">
                                        {{ __('messages.make_appointments') }}
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="row row-gap-20">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control text-area-input h-100" name="message" placeholder="{{ __('messages.form.type_message') }}"
                                                rows="4"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row row-gap-20">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="mb-0">
                                            <label class="text-white mb-1">{{ __('messages.user.your_message') }}
                                                <span class="text-danger">*</span></label>
                                            <textarea class="form-control text-area-input h-100 text-start" name="message" placeholder="{{ __('messages.form.type_message') }}"
                                                rows="4"></textarea>
                                        </div>
                                    </div>
                                    @if (isset($inquiry) && $inquiry == 1)
