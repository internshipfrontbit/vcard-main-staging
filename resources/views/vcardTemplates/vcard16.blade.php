        ...
        <div class="main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section pb-40 px-30  bg-primary">
                ...
                <div class="social-media mt-0 pt-0 mb-40 d-flex justify-content-center">
                    <div class="bg-vector-1">
                                <img src={{ asset('assets/img/vcard16/bg-vector-1.png') }} alt="bg-vector"/>
                                </div>
                                <div class="bg-vector-2">
                                <img src={{ asset('assets/img/vcard16/bg-vector-2.png') }} alt="bg-vector"/>
                                </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pt-40 pb-30">
                    <div class="bg-vector-3">
                                <img src={{ asset('assets/img/vcard16/bg-vector-3.png') }} alt="bg-vector"/>
                                </div>
                                <div class="bg-vector-4">
                                <img src={{ asset('assets/img/vcard16/bg-vector-4.png') }} alt="bg-vector"/>
                                </div>
