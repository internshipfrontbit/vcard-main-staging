        ...
        <div class="main-content mx-auto w-100 position-relative overflow-hidden bg-white">
            ...
            <div class="profile-section px-30 @if ($vcard->cover_type == 2) mt-3 @endif"
                ...
                <div class="card mb-30 d-flex flex-sm-row align-items-sm-stretch align-items-center border-0">
                    ...
                    <div class="card-body p-0 text-sm-start text-center">
                        ...
                        {{-- social-media --}}
                        <div class="social-media-section" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div
                                    class="d-flex flex-wrap justify-content-sm-start @if (getLanguage($vcard->default_language) == 'Arabic') justify-content-sm-end @endif justify-content-center gap-md-4 gap-3">
                ...
                <div class="text-gray-200" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if(!empty($vcard->email) || !empty($vcard->alternative_email || !empty($vcard->phone) || !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    <div class="contact-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="row">
                            <div class="col-sm-6  mb-sm-0 mb-30">
                                <div class="contact-img">
                                    <img src="{{ asset('assets/img/vcard36/contact-img.png') }}" alt="contact"
                                        class="w-100" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                @if ($vcard->email)
                                    <div class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3 mb-20">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard36/email.png') }}" />
                                        </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3 mb-20">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard36/phone.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3 mb-20">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard36/dob.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard36/location.png') }}" />
                                        </div>
                                        <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30">
                        <div class="gallery-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="gallery-bg img-3" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/vcard36/gallery-bg-3.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading right-heading" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60">
                        <div class="services-bg text-end" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-30">
                        <div class="product-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/vcard36/product-bg-1.png') }}" alt="bg-vector" />
                        </div>
                        <div class="product-bg img-2 text-end" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/vcard36/product-bg-2.png') }}" alt="bg-vector" />
                        </div>
                        <div class="product-bg img-3 text-end" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-desc card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <p class="amount fs-6 mb-0 fw-5 text-end text-success">
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="fs-18 fw-5 text-success">{{ $product->currency->currency_icon }}{{ number_format($product->price, 2) }}</span>
                                                        @elseif($product->price)
                                                            <span
                                                                class="fs-18 fw-5 text-success">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                                <div>
                                                    <p class="fs-14 text-black mb-0">{{ $product->description }}
                                                    </p>
                                                </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 px-30">
                        <div class="testimonial-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="testimonial-bg img-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60">
                        ...
                        <div class="blog-bg img-1">
                            <img src="{{ asset('assets/img/vcard36/blog-bg1.png') }}" alt="bg"
                                class="w-100" />
                        </div>
                        <div class="blog-bg img-2">
                            <img src="{{ asset('assets/img/vcard36/blog-bg2.png') }}" alt="bg"
                                class="w-100" />
                        </div>
                        ...
                        <div
                            class="blog-slider pb-sm-0 pb-60 px-sm-0 px-30 @if (getLanguage($vcard->default_language) == 'Arabic') blog-rtl @endif">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="contact-form">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel" class="form-control @if (getLanguage($vcard->deault_language) == 'Arabic') text-end @endif"
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="mb-5">
                        <div class="vcard-link-card card mb-3 mx-sm-3">
                            <div
                                class="d-flex align-items-center justify-content-center @if (getLanguage($vcard->default_language) == 'Arabic') me-3 @endif">
                    ...
                    <div class="modal-content" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="modal-body">
                            ...
                            <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <i class="fab fa-whatsapp text-black fa-2x" style="color: limegreen !important"></i>
                                    </div>
                                    <div class="col-9 p-1">
                                        <p class="align-items-center text-dark fw-bolder">
