...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            <!-- Profile Section -->
            <div class="profile-section mt-2 position-relative"
                ...
                <div class="social-bg">
                            <img src="{{ asset('assets/img/vcard34/social-bg.png') }}" alt="images"
                                class="img-fluid" />
                        </div>
                <div
                    class="row @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif">
                    @if (checkFeature('social_links') && getSocialLinkIcon($vcard))
                        ...
                        <div class="col-sm-6 mb-3">
                            <a href="{{ $social['url'] }}" target="_blank" class="text-decoration-none w-100">
                                <div class="social-item d-flex align-items-center text-white rounded-pill px-2 py-2 w-100">
                                    <div class="scoial-icon me-3 bg-white-100 rounded-circle d-flex justify-content-center align-items-center">
                                        {!! $social['icon'] !!}
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if(!empty($vcard->email) || !empty($vcard->alternative_email || !empty($vcard->phone) || !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    ...
                    <div class="personal-bg">
                            <img src="{{ asset('assets/img/vcard34/personal-bg.png') }}" alt="images"
                                class="img-fluid" />
                        </div>
                        @if (getLanguage($vcard->default_language) != 'Arabic')
                            <div class="personal-detalis position-relative py-2">
                                <div class="row">
                                    @if ($vcard->email)
                                    <div class="col-sm-6 mb-36">
                                        <div class="details-item">
                                        <div class="text-center position-relative z-2">
                                            <div
                                                class="details-icon bg-primary rounded-circle d-flex justify-content-center align-items-center">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    ...
                    <div class="gallery-bg position-absolute end-0 text-end">
                            <img src="{{ asset('assets/img/vcard34/gallery-bg.png') }}" alt="images"
                                class="img-fluid" />
                        </div>
                        <div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-section pt-40 pb-40 px-30px mb-40px position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="services-bg">
                            <img src="{{ asset('assets/img/vcard34/services-bg.png') }}" alt="images"/>
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    ...
                    <div class="testimonial-bg">
                            <img src="{{ asset('assets/img/vcard34/testimonial-bg.png') }}" alt="images"/>
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="time-table w-100">
                               ...
                               <div class="time-table-hour">
                                    <div class="d-flex justify-content-between align-items-center  gap-2 time-detail position-relative z-2">
                                        <p class="fs-14 fw-medium lh-base mb-0 days d-flex align-items-center gap-2">
                                            <span class="time-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#060606" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                ...
                <div class="qr-code-bg">
                            <img src="{{ asset('assets/img/vcard34/qr-code-bg.png') }}" alt="images"
                                class="img-fluid" />
                        </div>
                    <div
                    ...
                    <div class="container">
                        <div
                            class="qr-code-wrapper d-flex justify-content-center align-items-center m-0 flex-column flex-sm-row gap-4 @if (getLanguage($vcard->default_language) == 'Arabic') qr-box @endif">
                            <div class="mb-sm-0 mb-4 position-relative z-2">
                                <div class="qr-logo d-flex justify-content-center align-items-center">
                                    <div
                                        ...
                                        <div class="rotate-text position-absolute">
                                            <img src="{{ asset('assets/img/vcard34/black-text.png') }}"
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    ...
                    <div class="iframe-bg text-end">
                            <img src="{{ asset('assets/img/vcard34/iframe-bg.png') }}" alt="images"/>
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-section px-30px pt-40 pb-40"
                    @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="contact-bg">
                            <img src="{{ asset('assets/img/vcard34/contact-bg.png') }}" alt="images" />
                        </div>
                    <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                    ...
                    <form action="" id="enquiryForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-20px">
                            ...
                            <input type="text"
                                class="form-control fs-16 lh-base"
