        ...
        <div
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->email }}"
                                                class="text-black fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">{{ $vcard->email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->alternative_email }}"
                                                class="text-black fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">{{ $vcard->alternative_email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-black fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="text-black fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            @if ($vcard->dob)
                                <div class="col-12 col-sm-6 mb-sm-0 mb-4">
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <p
                                                class="text-black fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">
                                                {{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="services">
                            ...
                            @else
                                <div class="row row-gap-20px"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl"  @endif>
                                        @foreach ($vcard->services as $service)
                                          <div class="col-sm-6">
                                            <div class="service-card card d-flex flex-column gap-2 align-items-center h-100">
                                                <div class="card-img">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                ...
                                                <div
                                                    class="card-body p-0 text-center @if (getLanguage($vcard->default_language) == 'Arabic') me-3 @endif">
                                                    <h3 class="card-title fs-18 fw-5 text-black">
                                                        {{ ucwords($service->name) }}
                                                    </h3>
                                                    <p
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="">
                        <div class="section-heading left-heading mb-5 mt-5 text-white px-30"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="px-30">
                                <div class="bussiness-hour-card">
                                    @foreach ($businessDaysTime as $key => $dayTime)
                                        <div class="mb-10 d-flex align-items-center justify-content-between business-box flex-wrap flex-sm-nowrap">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 mb-3 position-relative px-30">
                        <div class="section-heading mb-5 text-white left-heading"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
