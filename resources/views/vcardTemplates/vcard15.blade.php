    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="bg-primary">
                <div class="profile-section px-30 profile-border position-relative">
                    <div class="position-absolute vector-6 text-end">
                        <img src="{{ asset('assets/img/vcard15/vector-6.png') }}" alt="images" class="w-50"/>
                    </div>
                    <div class="position-absolute vector-7">
                        <img src="{{ asset('assets/img/vcard15/vector-7.png') }}" alt="images" class="w-50"/>
                    </div>
                    <div class="position-absolute vector-8">
                        <img src="{{ asset('assets/img/vcard15/vector-8.png') }}" alt="images" class="w-25"/>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section bg-gray pt-3 pb-40 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard15/vector-4.png') }}" alt="images" class="w-100"/>
                    </div>
                        <div class="section-primary position-relative d-flex justify-content-center align-items-center">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 pb-40 position-relative">
                    <div class="position-absolute vector-10">
                        <img src="{{ asset('assets/img/vcard15/vector-10.png') }}" alt="images" class="w-25"/>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 pb-40 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard15/vector-5.png') }}" alt="images" class="w-100"/>
                    </div>
                   <div class="section-primary position-relative d-flex justify-content-center align-items-center mb-2">
                        <h2 class="font-cormorant text-primary text-center d-inline-block bg-white mb-0">{{ __('messages.plan.gallery') }}
                        </h2>
                    </div>
                        <div class="px-30">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-30 pb-30">
                      <div class="section-primary position-relative d-flex justify-content-center align-items-center">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">{{ __('messages.plan.products') }}
                        </h2>
                        </div>
                        <div class="px-30">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="blog-section pt-40 bg-gray-200">
                        <div class="text-center mb-40 section-primary position-relative d-flex align-items-center justify-content-center">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 pb-30 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard15/vector-3.png') }}" alt="images" class="w-100"/>
                    </div>
                     <div class="section-primary position-relative d-flex align-items-center justify-content-center">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">{{ __('messages.feature.blog') }}
                        </h2>
                    </div>
                      <div class="px-30">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="bussiness-hour-section pt-50 pb-60 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard15/vector-2.png') }}" alt="images" class="w-100"/>
                    </div>
                      <div class="section-primary position-relative d-flex align-items-center justify-content-center mb-30px">
                        <h2 class="font-cormorant text-primary text-center d-inline-block mb-0">
                            {{ __('messages.business.business_hours') }}
                        </h2>
                    </div>
                     <div class="px-30">
                        <div class="bussiness-hour-card row justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            @foreach ($businessDaysTime as $key => $dayTime)
                            <div class="col-sm-6">
                                <div class="mb-10 d-flex align-items-center justify-content-center business-box">
                                    <div class="fs-16 fw-medium">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}</div>
                                    <div class="text-primary fs-14 time d-flex gap-2 align-items-center">
                                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                                            ...
                                            <path fill="url(#clockGradient)" d="M232 120C232 106.7 242.7 96 256 96C269.3 96 280 106.7 280 120V243.2L365.3 300C376.3 307.4 379.3 322.3 371.1 333.3C364.6 344.3 349.7 347.3 338.7 339.1L242.7 275.1C236 271.5 232 264 232 255.1L232 120zM256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0zM48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48C141.1 48 48 141.1 48 256z"/>
                                        </svg>
                                        <div>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section bg-primary pt-50 pb-60 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard15/vector-9.png') }}" alt="images" class="w-50"/>
                    </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-10">
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center pt-2  d-flex justify-content-center position-relative">
                                            <button type="submit"
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="gallery-section pt-50 pb-4">
                     <div class="position-relative d-flex section-primary justify-content-center align-items-center mb-2">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">{{ __('messages.vcard.iframe') }}
                        </h2>
                    </div>
                        <div class="px-30">
            ...
            <div class="contact-us-section pt-20 pb-60 px-30">
                ...
                <div class="section-primary position-relative mb-30px d-flex align-items-center justify-content-center">
                    <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 pb-40 mb-5 position-relative">
                    <div class="position-absolute vector-all vector-1">
                        <img src="{{ asset('assets/img/vcard15/vector-1.png') }}" alt="images" class="w-100"/>
                    </div>
                    <div class="section-primary d-flex justify-content-center align-items-center position-relative mb-30px">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">
