                ...
                @if (getLanguage($vcard->default_language) != 'Arabic')
                    <div
                        ...
                        <div class="position-absolute text-end vector-all vector-2 position-absolute">
                            <img src="{{ asset('assets/img/vcard13/doctor-vector-2.png') }}" alt="vector-images" class="w-100"/>
                            </div>
                        ...
                        <div class="card-body pb-0 px-0 pt-0">
                            <div class="@if($vcard->cover_type == 2) profile-desc-margin @endif profile-name ">
                                ...
                                <p class="fs-16 fw-5 position-relative company-name mb-2">{{ ucwords($vcard->company) }}</p>
            ...
            @if (checkFeature('social_links') && isset($vcard->socialLink) && getSocialLink($vcard))
                <div class="social-media d-flex justify-content-center position-relative mb-40 px-30">
                    ...
                    <div class="position-absolute text-end vector-1 position-absolute">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-1.png') }}" alt="vector-images" class="w-50"/>
                    </div>
                    <div class="position-absolute vector-all vector-4 position-absolute">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-4.png') }}" alt="vector-images" class="w-100"/>
                    </div>
                </div>
            @endif
                                         ...
                                         <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                            ...
                                            <div class="contact-desc mt-2">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="text-primary">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div class="contact-box d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="contact-desc mt-2">
                                                <a href="mailto:{{ $vcard->alternative_email }}"
                                                    class="text-primary">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section mt-4 position-relative">
                    <div class="position-absolute text-end vector-all vector-5">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-5.png') }}" alt="vector-images" class="w-100"/>
                    </div>
                    <div class="position-absolute vector-all vector-6">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-9.png') }}" alt="vector-images" class="w-100"/>
                    </div>
                    <div class="section-heading position-relative text-center pb-40">
        ...
        <div class="position-relative vector-bg">
                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-card card">
                                                ...
                                                <div class="product-desc card-body">
                                                    ...
                                                    <div class="product-amount text-primary text-center fw-5 mt-2">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="my-5 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-7.png') }}" alt="vector-images" class="w-100"/>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section position-relative pb-40 mb-4  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                        <div class="position-absolute vector-all vector-8">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-8.png') }}" alt="vector-images" class="w-100"/>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="bussiness-hour-section pt-40 pb-40 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-6.png') }}" alt="vector-images" class="w-100"/>
                    </div>
                        ...
                        <div class="px-30">
                            <div class="bussiness-hour-card d-flex flex-column" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="row">
                                        <div
                                            class="col-sm-4 days">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}</div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-30 px-sm-4 px-3 mb-4 mx-3 mx-sm-4 position-relative">
                    <div class="position-absolute vector-all vector-11 text-end">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-10.png') }}" alt="vector-images" class="w-50"/>
                    </div>
                    <div class="section-heading position-relative text-center mb-3 pb-3">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 px-30 position-relative">
                    <div class="position-absolute vector-all vector-12">
                        <img src="{{ asset('assets/img/vcard13/doctor-vector-3.png') }}" alt="vector-images" class="w-100"/>
                    </div>
                    <div class="section-heading position-relative text-center mb-3 pb-3">
