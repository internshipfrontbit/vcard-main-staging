        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pt-40 pb-4 position-relative">
                    <div class="position-absolute vector-all vector-3 text-end">
                        <img src="{{ asset ('assets/img/vcard14/banner-vector-3.png') }}" alt="images" class="w-100"/>
                    </div>
                            ...
                            <div class="row">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-sm-0 mb-40">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard14/dob-icons.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard14/location-icons.png') }}" />
                                            </div>
                                            <div class="contact-desc">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 position-relative">
                    <div class="position-absolute vector-2 vector-all">
                        <img src="{{ asset('assets/img/vcard14/vector-qr-code-1.png') }}" alt="images" class="w-100"/>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section mt-5 position-relative">
                        ...
                        <img src="{{ asset ('assets/img/vcard14/service-vector-4.png') }}" alt="images" class="w-100"/>
                    </div>
                        <div class="section-heading-left">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-20 pb-40 position-relative">
                        ...
                        <img src="{{ asset ('assets/img/vcard14/testimonail-vector-5.png') }}" alt="images" class="w-100"/>
                    </div>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pb-4 mb-2 position-relative">
                        <div class="position-absolute vector-all vector-1">
                            <img src="{{ asset ('assets/img/vcard14/vector-1.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading-left">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-5 pb-2">
                        <div class="section-heading-left pb-4 mb-3">
                    ...
                    <div class="bussiness-hour-section mt-5">
                        ...
                        <div class="px-30 position-relative">
                            <div class="position-absolute vector-all vector-7">
                                <img src="{{ asset("assets/img/vcard14/business-vector-7.png") }}" alt="images" class="w-100"/>
                            </div>
                            <div class="position-absolute vector-all vector-6">
                                <img src="{{ asset("assets/img/vcard14//businness-vector-6.png") }}" alt="images" class="w-100"/>
                            </div>
                            <div class="bussiness-hour-card" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="mb-10 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap gap-2">
                                        <div class="me-2 w-25">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="my-5">
                        <div class="section-heading-left mb-2">
                            <h2 class="text-white">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section mb-5 position-relative">
                    <div class="section-heading-left mb-3 pb-3">
