    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            @if (getLanguage($vcard->default_language) != 'Arabic')
                <div class="profile-section px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                    <div class="position-absolute vector-1 vector-all">
                        <img src="{{ asset ('assets/img/vcard28/services-bg1.png') }}" alt="images" class="w-100" />
                        </div>
            ...
            @if (getLanguage($vcard->default_language) == 'Arabic')
                <div class="rtl" dir="rtl">
                    <div class="profile-section px-30 @if ($vcard->cover_type == 2) profile-margin @endif">
                        ...
                        <div class="card d-flex flex-column align-items-center mb-4 @if ($vcard->cover_type == 2) profile-min-height @else @endif">
                   ...
                   <div class="fs-14 text-center text-gray-500 profile-desc mb-30">
                    <p class="fs-14 text-center">
                        ...
                        {{-- social icons --}}
                        <div
                            class="social-media d-flex flex-wrap justify-content-center position-relative">
                            @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div
                                    class="social-icons d-flex justify-content-center text-decoration-none flex-wrap text-primary bg-gray-100 rounded-pill">
                                    @foreach (getSocialLink($vcard) as $value)
