...
<body>
    <div class="container p-0">
        ...
        {{-- profile section --}}
        <div class="profile-section px-40 pb-4 position-relative @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            <div class="position-absolute vector-all vector-1 text-end">
                <img src="{{  asset('assets/img/vcard33/vector-1.png') }}" alt="images" class="w-100"/>
                </div>
        ...
        {{-- social-media --}}
        <div class="social-media-section px-40 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            <div class="position-absolute vector-all vector-2">
                <img src="{{  asset('assets/img/vcard33/vector-2.png') }}" alt="images" class="w-100"/>
                </div>
        ...
        @if ((isset($managesection) && $managesection['products']) || empty($managesection))
            @if (checkFeature('products') && $vcard->products->count())
                                ...
                                <div class="product-card card">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product-desc card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-1 flex-column gap-2">
             ...
             <div class="text-center">
                <div class="mx-auto d-inline-flex gap-2 align-items-center mt-3 text-center view-more mb-5">
        ...
        @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
            @if (checkFeature('testimonials') && $vcard->testimonials->count())
                ...
                <img src="{{  asset('assets/img/vcard33/vector-3.png') }}" alt="images" class="w-100"/>
                </div>
                <div class="position-absolute vector-all vector-4">
                <img src="{{  asset('assets/img/vcard33/vector-4.png') }}" alt="images" class="w-100"/>
                </div>
                    <div class="section-heading mb-5 text-center text-white">
        ...
        @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
            @if (checkFeature('blog') && $vcard->blogs->count())
                ...
                <img src="{{  asset('assets/img/vcard33/vector-5.png') }}" alt="images" class="w-100"/>
                </div>
                    <div class="section-heading mb-5 text-center text-white">
            ...
            @if ($vcard->businessHours->count())
                ...
                <div class="business-hour-section pt-60 pb-60 px-40 position-relative">
                        <div class="position-absolute vector-all vector-6 text-end">
                            <img src="{{  asset('assets/img/vcard33/vector-6.png') }}" alt="images" class="w-100"/>
                        </div>
                    <div class="section-heading mb-5 text-center text-white">
                            ...
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="col-sm-12 mb-3 pe-sm-2">
                                    <div class="business-hour flex-wrap">
                                        <div class="w-50">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}:</div>
        ...
        @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
            <div class="contact-us-section pt-60 pb-40 px-40 position-relative">
                <div class="position-absolute vector-all vector-7 text-end">
                            <img src="{{  asset('assets/img/vcard33/vector-7.png') }}" alt="images" class="w-100"/>
                        </div>
                <div class="section-heading mb-5 text-center text-white">
