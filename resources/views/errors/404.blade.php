...
<div class="container con-404 vh-100 d-flex justify-content-center">
    <div class="row justify-content-md-center d-block">
        <div class="col-md-12 mt-5">
            <img src="{{ asset('img/plan-expire.png') }}" class="img-fluid img-404 mx-auto d-block">
        </div>
        <div class="col-md-12 text-center error-page-404">
            ...
            <!--    incorrectly.</p>-->
            <a class="btn btn-primary back-btn mt-3" href="https://staging.vcardking.com" >Back to Previous Page</a>
        </div>
    </div>
</div>
