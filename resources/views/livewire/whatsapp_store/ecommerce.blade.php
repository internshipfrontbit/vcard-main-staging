<div class="row">
    ...
    <div class="col-xl-9 col-lg-8">
        <div class="row justify-content-end">
            <div class="col-xl-4 col-sm-6 mb-20">
                <div class="position-relative">
                    <input type="search" placeholder="{{ __('messages.whatsapp_stores_templates.search_products') }}" id="productSearch"
        ...
        <div class="row mb-40 custom-row product-gap-row product-section">
                ...
                <div class="col-xl-3 col-sm-6 mb-20">
                    <div class="h-100 product-card d-flex flex-column">
                        ...
                        <div class="product-details" style="flex-grow: 1;">
                            ...
                            @if (request()->getHost() === 'staging.vcardking.com') 
                            <a href="{{ route('whatsapp.store.product.details', [$urlAlias, $product->id]) }}" style="color: #000000;">
                            @else
                            <a href="{{ route('whatsapp.store.product.details', [$product->id]) }}" style="color: #000000;">
                            @endif
                                ...
                                <div class="d-flex gap-2 d-flex-custom align-items-center justify-content-between">
                                    <p class="fs-30 fw-6 lh-sm mb-0 min-height-new-ecom ">
