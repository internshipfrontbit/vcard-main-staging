...
@section('section')
    <div class="card w-100">
        <div class="card-body d-flex">
            ...
            <div class="col-lg-12">
                <div class="mb-5">
                    {{ Form::label('refund_cancellation', __('Refund & Cancellation Policy').':', ['class' => 'form-label']) }}
            ...
            <div class="col-lg-12">
                <div class="mb-5">
                    {{ Form::label('shipping_delivery', __('Shipping & Delivery Policy').':', ['class' => 'form-label']) }}
