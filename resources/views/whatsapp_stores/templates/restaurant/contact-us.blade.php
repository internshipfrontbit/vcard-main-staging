...
<div class="container mt-4" style="min-height: 50vh;">
    <h2 class="text-center-new mb-2" style="font-weight: 600;">Keep In Touch with Us</h2>
    <hr style="width: 80px; border-top: 3px solid #ffffff; margin-bottom: 50px; margin: auto;">
    ...
    <div class="row justify-content-center align-items-start "style="margin-top: 50px; margin-bottom: 100px;">
        ...
        <div class="col-md-4 mb-4">
            ...
            <p>
                <i class="fas fa-phone me-2" style="color: white;"></i>
            ...
            <div class="mt-3 mt-md-0 mb-2">
                <i class="fas fa-map-marker-alt title-text me-2" style="color: white;"></i> 
                <span style="color: white;">{{ $whatsappStore->address }}</span>
            </div>
