                    ...
                    @foreach ($whatsappStore->products()->latest()->take(8)->get() as $product)
                        <div class="col-xl-3 col-lg-4 col-sm-6 mb-28">
                            ...
                            @endif
                                        ...
                                        <div class="d-flex gap-2 align-items-center justify-content-between d-flex-custom">
                            ...
                            @endif
                                                ...
                                                class="d-flex text-black flex-column h-100 min-height-new-ecom">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                class="@if($product->available_stock == 0) disabled @endif btn btn-primary d-flex justify-content-center align-items-center addToCartBtn" style="margin-right: 5px;">
