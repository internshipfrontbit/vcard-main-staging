            ...
            <div class="slider-nav">
                ...
                <div>
                    <div class="thumbnail-img">
                        <img src="{{ $image }}" alt="items" class="w-100 h-100 object-fit-cover rounded image-thumbnail"
                            loading="lazy" data-image="{{ $image }}" />
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="col-lg-9 col-sm-10 ps-sm-0 mb-4 mb-sm-0">
            ...
            <div id="mainDisplay" class="mb-20" style="position: relative;">
                ...
                <div class="zoom-container" id="zoomContainer" style="{{ $videoId ? 'display: none;' : 'display: block;' }}">
                    ...
                    <img id="mainImage" src="{{ $product->images_url[0] }}" alt="items"
                        class="w-100 h-100 object-fit-cover rounded" loading="lazy"
                        style="{{ 'display: none;' }}" />
                    ...
                    <iframe id="mainVideo"
                        ...
                        class="w-100 h-100 rounded" style="display: block;">
                    </iframe>
                    @endif

                    <!-- Download Button Wrapper -->
                    @if (count($product->images_url) > 1)
                    <button class="btn btn-primary d-flex justify-content-center align-items-center download-icon-btn"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 25" fill="none">
                            <path d="M12 5V15M5 12L12 19L19 12" stroke="currentColor" stroke-width="2"
        ...
        <img id="mobileZoomImage" src="" alt="zoomed image" />
                            ...
                            <div class="col-lg-6 px-0">
                                <div class="ps-0 ps-lg-3 details d-flex justify-content-between flex-column h-100">
                                    <div>
                                        ...
                                        @if($whatsappStore->id == 208)
                                            @if(!empty($product->cartoon_qty))
                                                <p class="fs-20 fw-6 text-gray-200 mb-10 lh-sm">Cartoon Quantity:</p>
                                    ...
                                    <div class="d-flex">
                                        <button
                                            class="btn btn-primary d-flex justify-content-center align-items-center w-50 fs-18 gap-2 addToCartBtn mx-2"
                                            data-id="{{ $product->id }}">
                                            <span>
