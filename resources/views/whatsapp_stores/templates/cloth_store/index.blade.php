        ...
        @endif
            ...
            <div class="product-section px-50 pt-30 position-relative">
                ...
                <div class="mb-50 product-list-section">
                    ...
                    @php($productLimit= $whatsappStore->id == 1874 ? 100 : 8)

                        @foreach ($whatsappStore->products()->where('is_active','=',true)->orderByRaw('position IS NULL, position ASC')->orderBy('created_at', 'desc')->take($productLimit)->get() as $product)
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                <div>
                                                    <div class="d-flex gap-2  mb-10 ">
                                                     ...
                                                     @if($whatsappStore->id == 530)
                                                        <p class="fs-14 fw-5 mb-2 text-gray-200 lh-sm" style="width: 91%;word-wrap: break-word;">{{$product->sizes}}</p>
                                                    @endif
