                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="d-flex align-items-center gap-lg-4 gap-sm-3 gap-2">
                        ...
                        <!-- <div>
                            <small>
                                @if (request()->getHost() === 'staging.vcardking.com') 
                                    <a href="{{ route('whatsapp.store.about', ['alias' => $whatsappStore->url_alias]) }}" class="footer-link-new">About Us</a>
                                @else
                                    <a href="{{ route('whatsapp.store.about') }}" class="footer-link-new">About Us</a>
                                @endif
                            </small>
                        </div>                         -->
