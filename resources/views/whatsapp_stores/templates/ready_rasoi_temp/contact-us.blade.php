...
<body>
    ...
    <div class="main-content mx-auto w-100 mw-100 overflow-hidden d-flex flex-column justify-content-between"
...
<div class="container mt-4 md:pt-32 pt-24" style="min-height: 50vh;">
    <h2 class="text-center mb-2" style="font-weight: 600;">Keep In Touch with Us</h2>
    <hr style="width: 80px; border-top: 3px solid #000; margin-bottom: 50px; margin: auto;">

    <div class="row justify-content-center align-items-start "style="margin-top: 50px; margin-bottom: 100px;">


        {{-- Embedded Map --}}
        <div class="col-md-6">
            <div class="ratio ratio-4x3" style="max-width: 100%;">
                {!! $whatsappStore->contact_us !!}
            </div>
        </div>
        {{-- Contact Info --}}
        <div class="col-md-4 mb-4">
            ...
            <div class="mt-3 mt-md-0 mb-2">
                <i class="fas fa-map-marker-alt title-text me-2"></i> {{ $whatsappStore->address }}
            </div>
