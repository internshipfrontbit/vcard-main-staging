        ...
        <div class="card">
            <div class="card-body d-sm-flex position-relative px-2">
                ...
                <div class="ps-sm-3 pt-lg-auto pt-0 w-100 overflow-auto px-1" id="main">
                    ...
                    @elseif($partName === 'social-links')
                        @include('whatsapp_stores.social-link.index')
                    @elseif($partName === 'youtube-embed')
                        @include('whatsapp_stores.youtube_embed.index')     
                    @elseif($partName === 'pages')
                        @include('whatsapp_stores.pages.index')                        
                    @elseif($partName === 'other')
                        @include('whatsapp_stores.other.index')      
                    @elseif($partName === 'customOrder')
                        @include('whatsapp_stores.customorder.index')
                    @elseif($partName === 'payment')
                        @include('whatsapp_stores.payment.index')                           
                    @elseif($partName === 'custom-theme')
                        @include('whatsapp_stores.customize_theme.index')                                                                      
                    @endif
                </div>
            </div>
        </div>
