...
{{--                    {{__('auth.copyright_by')." "}} <span class="text-success">{{ $setting['app_name'] }}</span></p> --}}, powered by 
        ...
        Frontbit Solutions
                ...
                <div class="col-6"> <a href="{{ route('terms.conditions') }}" target="_blank"
                    ...
                    <a href="{{ route('refund.cancellation.policy') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{{ __('Refund & Cancellation Policy') }}</a>
                    <span class="slash">|</span>
                    <a href="{{ route('shipping.delivery.policy') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{{ __('Shipping & Delivery Policy') }}</a>
                </div>
            </div>
        </div>
        </div>
