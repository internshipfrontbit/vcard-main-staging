        ...
        <div class="container pt-60 mt-3">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="fs-40 text-white"> Website Templates </h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-60">
                        <div
                            ...
                            <div class="card-img">
                                <a href="https://staging.vcardking.com/whatsapp-store/jewellery-shop" target="_blank">
                                    <img src="{{ asset('assets/img/new_design_temp/wp-1.png') }}" class="w-100 img-fluid">
                                </a>
                            </div>
                            <div class="card-body p-0 pt-4 mt-1">
                                <h6 class="fs-20 text-center">Jewelery Shop</h6>
                            </div>
                        </div>
                    </div>   
                    <div class="col-lg-4 col-sm-6 mb-60">
                        <div
                            class="template-card h-100">
                            <div class="card-img">
                                 <a href="https://staging.vcardking.com/whatsapp-store/grocery-shop" target="_blank">
                                    <img src="{{ asset('assets/img/new_design_temp/wp-2.png') }}" class="w-100 img-fluid">
                                </a>
                            </div>
                            <div class="card-body p-0 pt-4 mt-1">
                                <h6 class="fs-20 text-center">Grocery Shop</h6>
                            </div>
                        </div>
                    </div>        
                    <div class="col-lg-4 col-sm-6 mb-60">
                        <div
                            class="template-card h-100">
                            <div class="card-img">
                                <a href="https://staging.vcardking.com/whatsapp-store/beauty-shop" target="_blank">
                                    <img src="{{ asset('assets/img/new_design_temp/wp-7.png') }}" class="w-100 img-fluid">
                                </a>
                            </div>
                            <div class="card-body p-0 pt-4 mt-1">
                                <h6 class="fs-20 text-center">Beauty Shop</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-60">
                        <div
                            class="template-card h-100">
                            <div class="card-img">
                                <a href="https://staging.vcardking.com/whatsapp-store/restaurant" target="_blank">
                                    <img src="{{ asset('assets/img/new_design_temp/wp-6.png') }}" class="w-100 img-fluid">
                                </a>    
                            </div>
                            <div class="card-body p-0 pt-4 mt-1">
                                <h6 class="fs-20 text-center">Restaurant Shop</h6>
                            </div>
                        </div>
                    </div>  
                     <div class="col-lg-4 col-sm-6 mb-60">
                        <div
                            class="template-card h-100">
                            <div class="card-img">
                                <a href="https://staging.vcardking.com/whatsapp-store/ecommerce" target="_blank">
                                    <img src="{{ asset('assets/img/new_design_temp/wp-3.png') }}" class="w-100 img-fluid">
                                </a>
                            </div>
                            <div class="card-body p-0 pt-4 mt-1">
                                <h6 class="fs-20 text-center">Ecommerce Shop</h6>
                            </div>
                        </div>
                    </div>    
                    <div class="col-lg-4 col-sm-6 mb-60">
                        <div
                            class="template-card h-100">
                            <div class="card-img">
                                <a href="https://staging.vcardking.com/whatsapp-store/home-made" target="_blank">
                                    <img src="{{ asset('assets/img/new_design_temp/wp-8.png') }}" class="w-100 img-fluid">
                                </a>
                            </div>
                            <div class="card-body p-0 pt-4 mt-1">
                                <h6 class="fs-20 text-center">Home Made Shop</h6>
                            </div>
                        </div>
                    </div>    
            </div>
                    ...
                    <div class="col-md-7 text-md-start text-center mb-md-0 mb-2">
                        <p class="text-black fw-light mb-0">
                            © {{ \Carbon\Carbon::now()->year }} {{ __('auth.copyright_by') . ' ' }}<span
                                ...
                                , powered by 
    <a href="https://frontbitsolutions.com/" target="_blank" rel="noopener noreferrer">
        Frontbit Solutions
    </a> 
                        </p>
                    </div>
